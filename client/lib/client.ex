defmodule Client do
  ...
  Включает "heartbeat" механику для текущего соединения, данное действие позволяет поддерживать
  ...
  Выключает "heartbeat" механику для текущего соединения, соединение не будет поддерживаься постоянно
  и в случае простоя будет отключено по таймауту заданному на сервере. Имейте ввиду что при переподключении
  механизм будет в состоянии указанном в настройках конфигурационного файла.
